...
public class MathUtil
{
    ...
    /// <returns></returns>
    public static DateTime Seconds2DateTime(uint seconds)
    {
        DateTime dt = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));
        long lTime = long.Parse(seconds.ToString() + "0000000");
    ...
    /// <returns></returns>
    public static uint DateTime2Seconds(DateTime dateTime)
    {
        DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));

        return (uint)(dateTime - startTime).TotalSeconds;
    }
